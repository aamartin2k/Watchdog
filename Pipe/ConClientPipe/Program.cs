...
/*  
   Este cliente realiza una implementación del emisor de Heartbeat reutilizando código fuente.
   El proyecto contiene una referencia a la dll Monitor.Shared. 
   Se hace referencia a las clases HbSenderPipe y HeartBeatGenerator.
 */
